      ...
      <div className="my-0 mx-auto w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
        ...
        <form action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
          ...
          <div className="space-y-1 text-sm">
            ...
            <input type="text" name="email" id="email" className="border-b-2 border-gray-700 w-full px-2 py-2 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
          </div>
          ...
          <button className="transition-colors duration-300 transform block w-full p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400 dark:hover:bg-violet-500 bg-blue-500 hover:bg-blue-600 text-white">Sign up</button>
        </form>
        ...
        <p className="text-xs text-center sm:px-6 dark:text-gray-400">Have an account?
          <a rel="noopener noreferrer" href="#" className="underline dark:text-gray-100"> Login in</a>
        </p>
      </div>
    </section>
    ...
    <section className="flex items-center flex-1">
      <div className="my-0 mx-auto w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
        ...
        <form action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
          ...
          <button className="transition-colors duration-300 transform block w-full p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400 dark:hover:bg-violet-500 bg-blue-500 hover:bg-blue-600 text-white">Log in</button>
        </form>
        <div className="flex items-center pt-4 space-x-1">
          <div className="flex-1 h-px sm:w-16 bg-gray-700"></div>
